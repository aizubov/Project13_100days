...
//  Project13_100days
//
//  Created by user228564 on 2/6/23.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        changefilterButton.setTitle("Change filter: CISepiaTone", for: .normal)
    ...
    @IBAction func save(_ sender: Any) {
        guard let image = imageView.image else {
            ...
            let ac = UIAlertController(title: "Error while saving", message: "No image found", preferredStyle: .alert)
